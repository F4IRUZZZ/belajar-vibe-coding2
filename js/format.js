...
function ikon(nama) {
  const paths = {
    ...
    'mata-coret': '<path d="M12 7a5 5 0 0 1 5 5 5 5 0 0 1-.65 2.45l2.1 2.1A11.5 11.5 0 0 0 23 12s-2.2-4.63-5.75-6.57l2.48-2.48-1.41-1.41-9.83 9.83A4.96 4.96 0 0 0 12 17c.39 0 .77-.05 1.14-.13l-1.9-1.9A2.98 2.98 0 0 1 12 13c-.11 0-.22.01-.32.02l-2.45-2.45A4.97 4.97 0 0 1 12 7zM2.71 3.16 1.3 4.57l2.4 2.4A11.4 11.4 0 0 0 1 12s2.28 4.79 6 6.68l2.57 2.57 1.41-1.41-9.27-9.27z"/>'
  };
